...
- SKILL.md: 150 lines max (the attention-quality target; Anthropic recommends staying under 500, but staying near 150 keeps the whole file in high-recall range)
